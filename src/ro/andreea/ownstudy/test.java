    ...
    Ex cerc neede raza, patrat needes latura and triughi needs latura in order to calculate the area and perimeter.
        ...
        public static void main(String[] args) {
            ...
            while(option != 4) {
                switch (option) {
                    case 1: {
                        System.out.println("Ati ales patratul");
                        System.out.println("Dati latura patratului: ");
                        double latura = Double.parseDouble(input.nextLine());
                        System.out.println("Aria este:"+area("patrat", latura));
                        System.out.println("Perimetru este: "+ perimeter("patrat",latura));

                    }
                    break;
                    case 2: {
                        System.out.println("Ati ales cercul");
                    }
                    break;
                    case 3: {
                        System.out.println("Ati ales triunghiul echilateral");
                    }
                    break;
                    default: {
